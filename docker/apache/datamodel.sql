...
--
-- Table structure for table `assetmovementsbook`
--
...
--
-- Table structure for table `projectmessage`
--
...
--
-- Table structure for table `pwarchive`
--
...
--
-- Table structure for table `pwownerlog`
--
...
--
-- Table structure for table `pwstatuslog`
--
...
--
-- Table structure for table `pwvisibility`
--
...
(1, 1, 1, 'Admin', '', 'admin', '$2y$10$lisaKfP5VQ6.UM.AdN8C1u696UZnnVGc.eSDytaTC3eFtIf9XLM7q', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `useroffice`
--
...
--
-- Table structure for table `usroffice`
--
...
--
-- Dumping data for table `usroffice`
--
...
--
-- Indexes for table `assetmovementsbook`
--
ALTER TABLE `assetmovementsbook`
  ADD PRIMARY KEY (`asmb_id`);

--
-- Indexes for table `forminstance`
--
...
--
-- Indexes for table `projectmessage`
--
...
--
-- Indexes for table `pwarchive`
--
ALTER TABLE `pwarchive`
  ADD PRIMARY KEY (`fi_id`);

--
-- Indexes for table `pwownerlog`
--
ALTER TABLE `pwownerlog`
  ADD PRIMARY KEY (`pwol_id`);

--
-- Indexes for table `pwstatuslog`
--
ALTER TABLE `pwstatuslog`
  ADD PRIMARY KEY (`rpsl_id`);

--
-- Indexes for table `pwvisibility`
--
...
--
-- Indexes for table `useroffice`
--
ALTER TABLE `useroffice`
  ADD PRIMARY KEY (`usroff_id`);

--
-- Indexes for table `usroffice`
--
...
--
-- AUTO_INCREMENT for table `assetmovementsbook`
--
ALTER TABLE `assetmovementsbook`
  MODIFY `asmb_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `forminstance`
--
ALTER TABLE `forminstance`
...
--
-- AUTO_INCREMENT for table `projectmessage`
--
ALTER TABLE `projectmessage`
...
--
-- AUTO_INCREMENT for table `useroffice`
--
ALTER TABLE `useroffice`
  MODIFY `usroff_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `usroffice`
--
ALTER TABLE `usroffice`
