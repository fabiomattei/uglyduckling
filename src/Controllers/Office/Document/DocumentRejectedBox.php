 ...
 */
class DocumentRejectedBox extends Controller {
    ...
    public function getRequest() {
        $this->title = $this->setup->getAppNameForPageTitle() . ' :: Rejected documents box';
        ...
        $table->setTitle('Rejected documents box');
        ...
        foreach ( $this->jsonloader->getResourcesIndex() as $res ) {
            if ( $res->type === 'document' ) {
                ...
                if ( $this->sessionWrapper->getSessionGroup() === $resource->destinationgroup ) {
                    ...
                    $entities = $this->documentDao->getGroupRejectedBox(
                        $resource->object,
