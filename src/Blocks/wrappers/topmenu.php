 ...
 * Time: 11:32
 */
class TopMenu extends BaseBlock {

	function __construct( $office_id, $active='index' ) {
		$this->office_id = $office_id;
		$this->active    = $active;
	}
	
	function show() {
		$out = '<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
      ...
      <ul class="nav navbar-top-links navbar-right pull-right">
        ...
        <!-- /.dropdown -->
        <li class="dropdown"> <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <b class="hidden-xs">'.$_SESSION['username'].'</b> </a>
          <ul class="dropdown-menu dropdown-user animated flipInY">
            <li><a href="'.make_url( 'user', 'profile' ).'"><i class="ti-user"></i> My Profile</a></li>
            <li><a href="'.make_url( 'user', 'changeoffice' ).'"><i class="ti-wallet"></i> Change Office</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="'.make_url( 'user', 'updatepassword' ).'"><i class="ti-settings"></i> Update Password</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="'.make_complete_url( 'public', 'main', 'logout' ).'"><i class="fa fa-power-off"></i> Logout</a></li>
          </ul>
          <!-- /.dropdown-user -->
        </li>
        <!-- /.dropdown -->
