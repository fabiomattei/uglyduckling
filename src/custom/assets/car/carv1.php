...
require_once( 'core/paperworks/basicasset.php' );
 ...
 * Time: 08:56
 */
class StudentV1 extends BasicAsset {

    public $slug        = 'basicasset';
    public $base_slug   = 'basicasset';
    public $family_slug = 'basicasset';
    public $human_name  = 'Basic Asset';
